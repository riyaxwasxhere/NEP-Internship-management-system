  ...
  return (
    <div>
      <div className="p-15 md:px-30 md:py-20 bg-blue-600 text-center flex justify-center">
        <div className="max-w-4xl text-center">
          ...
          <button
            ...
            className="p-2 px-5 bg-white text-xl font-semibold rounded  hover:scale-105 cursor-pointer"
          >
            Get Started
          </button>
      ...
      <div className="text-center bg-blue-600 p-10">
        ...
        <button
          onClick={() => setLoginOpen(true)}
          className="px-5 p-3 bg-white rounded hover:scale-105 font-bold text-lg"
        >
          Get Started
        </button>
      </div>
