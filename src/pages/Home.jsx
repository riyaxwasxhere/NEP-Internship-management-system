  ...
  return (
    <div>
      <div className="p-15 md:px-30 md:py-20 bg-blue-600 text-center flex justify-center">
        <div className="max-w-4xl text-center">
          <h1 className="md:text-5xl text-4xl font-bold text-white">
            NEP Internship Management System
          </h1>
          <p className="text-xl text-white my-10">
            Connecting Students, Companies, and Colleges for verified,
            credit-worthy internships under the National Education Policy
          </p>
          <button className="p-2 px-5 bg-white text-xl font-semibold rounded  hover:scale-105 cursor-pointer">
            Get Started
          </button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(275px,0.9fr))]  justify-around gap-5 py-15 px-10 md:px-20">
          <div className="flex flex-col gap-3 p-5 border-1 rounded-lg bg-white">
            ...
            <p className=" text-gray-600 font-semibold">
              All internships are verified by faculty coordinators ensuring
          ...
          <div className="flex flex-col gap-3 p-5 border-1 rounded-lg bg-white">
            ...
            <p className=" text-gray-600 font-semibold">
              Students maintain daily progress logs reviewed and approved by
              faculty members
            </p>
          </div>
          <div className="flex flex-col gap-3 p-5 border-1 rounded-lg bg-white">
            ...
            <p className=" text-gray-600 font-semibold">
              Earn academic credits upon successful completion and faculty
              approval
            </p>
          </div>
        </div>
      ...
      <div className="bg-gray-100 py-10">
        <h1 className="pt-10 text-3xl font-semibold text-center">
          Who Can Join ?
        </h1>
        <div className="grid grid-cols-[repeat(auto-fit,minmax(275px,0.9fr))] gap-10 items-center justify-center px-10 py-10 md:px-20">
          <div className="p-5 text-center border-1 rounded-xl shadow-xl  bg-white">
            ...
            <p className="py-5 text-sm text-gray-600 font-semibold">
              Find verified internships, maintain logbooks, and earn NEP
              credits.
            </p>
          ...
          <div className="p-5 text-center border-1 rounded-xl shadow-xl  bg-white">
            ...
            <p className="py-5  text-sm text-gray-600 font-semibold">
              Post internships, manage applications, and discover talented
              students.
            </p>
            <ul className="list-disc text-left pl-5 text-sm text-gray-600">
          ...
          <div className="p-5 text-center border-1 rounded-xl shadow-xl  bg-white">
            ...
            <p className="py-5 text-sm text-gray-600 font-semibold">
              Verify internships, approve logbooks, and assign NEP credits
            </p>
            <ul className="list-disc text-left pl-5 text-sm text-gray-600">
      ...
      <div className="text-center bg-blue-600 p-10">
        ...
        <p className="text-white font-semibold my-7 text-xl">
          Join the platform that's revolutionizing internship management under
          NEP guidelines
        </p>
        <button className="px-5 p-3 bg-white rounded hover:scale-105 font-bold text-lg">
          Sign Up Now
        </button>
      </div>
      <div className="p-7">
        <p className="text-center">
          © 2025 NEP Internship Management System - Smart India Hackathon
          Project
        </p>
      </div>
    </div>
